...
public class OrderButtonAtTheTop implements OrderFormFiller {
    ...
    public OrderButtonAtTheTop(String browser, String name, String lastName, String address, String station,
                               String phone) {
    ...
    private void fillPersonalInfo() {
        ...
        clickElement(Locators.OrderPageLocators.CLICK_METRO_SELECTION_FIELD);
    ...
    public void testOrderButtonTop() {
        ...
        clickElement(OrderPageLocators.CLICK_TOP_BUTTON);
        System.out.println("Нажать кнопку 'Заказать' успешно");
